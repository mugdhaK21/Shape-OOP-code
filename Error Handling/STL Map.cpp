...
public:
    ...
    T peek() { return stackArray[top - 1]; }
};
...
int main()
{
    ...
    intArray.display();
    intArray.push(20);
    cout << "Popped element is: " << intArray.pop() << endl;
    intArray.display();
    cout << "The total elements are: " << intArray.get_top() << endl;
    cout << "The top element is " << intArray.peek() << endl;

    SafeArray<double> safearr;
    double d = safearr[0];
    cout << d << endl;

    double err = safearr[10];
